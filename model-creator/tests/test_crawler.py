...
class TestWebsiteCrawler(unittest.TestCase):
    ...
    def test_detect_patterns(self):
        ...
        # Login patterns
        self.assertTrue(self.crawler.detect_patterns('Please login to continue', self.crawler.login_patterns))
        self.assertTrue(self.crawler.detect_patterns('Sign in here', self.crawler.login_patterns))

        # Logout patterns
        self.assertTrue(self.crawler.detect_patterns('Logout', self.crawler.logout_patterns))

        # Error patterns
        self.assertTrue(self.crawler.detect_patterns('Error: Invalid credentials', self.crawler.error_patterns))
...
class TestFormField(unittest.TestCase):
    ...
    def test_creation(self):
        ...
        field = FormField(name='username', field_type='text', required=True, options=[], default_value='test')
