...
class TestModelGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pages = {
            "https://example.com": Page(
                ...
                forms=[],
                links=[
                    Link(url="https://example.com/about", text="About", source_page="https://example.com")
                ],
            ),
            ...
            "https://example.com/about": Page(
                ...
                forms=[],
                links=[
                    Link(url="https://example.com", text="Home", source_page="https://example.com/about")
                ],
            ),
        }
    ...
    def test_get_page_name(self):
        ...
        self.assertEqual(
            self.generator.get_page_name("https://example.com/user/profile"),
            "user_profile"
        )
    ...
    def test_get_form_name(self):
        ...
        search_form = Form(
            action="/search",
            method="GET",
            fields=[FormField(name="search", field_type="text")]
        )
