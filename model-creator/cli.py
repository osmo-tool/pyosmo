...
Examples:
  ...
  python -m model-creator create https://example.com -o models/example.py \\
    ...
    create_parser.add_argument('-o', '--output', required=True, help='Output path for the generated model')
    create_parser.add_argument(
        '-c', '--class-name', default='WebsiteModel', help='Name of the model class (default: WebsiteModel)'
    )
    create_parser.add_argument(
        '-m', '--max-pages', type=int, default=50, help='Maximum number of pages to crawl (default: 50)'
    )
    create_parser.add_argument(
        '-d', '--delay', type=float, default=0.5, help='Delay between requests in seconds (default: 0.5)'
    )
    create_parser.add_argument('--follow-external', action='store_true', help='Follow external links')
    create_parser.add_argument('--username', help='Username for basic authentication')
    create_parser.add_argument('--password', help='Password for basic authentication')
    create_parser.add_argument('--save-crawl', action='store_true', help='Save crawl data to JSON file')
    ...
    update_parser.add_argument('--follow-external', action='store_true', help='Follow external links')
    update_parser.add_argument('--username', help='Username for basic authentication')
    update_parser.add_argument('--password', help='Password for basic authentication')
    update_parser.add_argument('-y', '--yes', action='store_true', help='Skip confirmation prompt')
    update_parser.add_argument('--no-backup', action='store_true', help="Don't create backup of existing model")
